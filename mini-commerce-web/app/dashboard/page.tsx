          ...
          <section className="rounded-3xl border border-white/10 bg-slate-900/90 p-10 shadow-[0_30px_90px_rgba(15,23,42,0.55)] backdrop-blur-xl">
            ...
            {user && (
              <p className="mt-4 text-slate-300">
                Bem-vindo, <strong>{user.name}</strong> — Perfil:{" "}
                <strong>{getRoleLabel(user.role)}</strong>
              </p>
            )}

            <p className="mt-4 max-w-2xl text-slate-400">
              Acompanhe seus produtos, pedidos e categorias em tempo real com
              controles rápidos para acessar cada área.
            </p>
          </section>
            ...
            <>
              <div className="grid gap-6 md:grid-cols-3">
                <div className="rounded-3xl border border-white/10 bg-slate-900/95 p-8 shadow-lg">
                  ...
                  <p className="mt-3 text-sm text-slate-400">
                    Total de produtos cadastrados no catálogo.
                  </p>
                </div>
                ...
                <div className="rounded-3xl border border-white/10 bg-slate-900/95 p-8 shadow-lg">
                  ...
                  <p className="mt-3 text-sm text-slate-400">
                    Pedidos realizados até o momento.
                  </p>
                </div>
              ...
              <div
                className={`grid gap-6 md:grid-cols-2 ${
                  admin ? "xl:grid-cols-4" : "xl:grid-cols-2"
                }`}
              >
                <Link
                  href="/products"
                  className="rounded-3xl border border-white/10 bg-slate-900/90 p-8 shadow-lg transition hover:bg-slate-800"
                >
                  <p className="font-semibold text-white">Produtos</p>
                  <p className="mt-3 text-sm text-slate-400">
                    Gerencie o catálogo e os detalhes de cada item.
                  </p>
                </Link>
                ...
                >
                  ...
                  <p className="mt-3 text-sm text-slate-400">
                    Veja e atualize o status dos pedidos feitos.
                  </p>
                </Link>
                ...
                {admin && (
                  <Link
                    href="/products/new"
                    className="rounded-3xl border border-white/10 bg-cyan-500/10 p-8 shadow-lg transition hover:bg-cyan-500/15"
                  >
